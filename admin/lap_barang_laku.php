...
$pdf->SetX(4);            
$pdf->MultiCell(19.5,0.5,'OUTLET POLIJE',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'Telpon : 08xx',0,'L');    
$pdf->SetFont('Arial','B',10);
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'JL. PB SUDIRMAN',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'website : www.polije.ac.id ',0,'L');
