	...
	<div class="navbar navbar-default">
		<div class="container-fluid">
			<div class="navbar-header">
				<a href="http://www.malasngoding.com" class="navbar-brand">OUTLET POLIJE</a>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					while($q=mysql_fetch_array($periksa)){	
						if($q['jumlah']<=3){			
							echo "<div style='padding:5px' class='alert alert-warning'><span class='glyphicon glyphicon-info-sign'></span> Stok  <a style='color:red'>". $q['nama']."</a> yang tersisa hari ini tanggal 22-10-2017 adalah  3 buah . silahkan retur besok tanggal 23-10-2017 !!</div>";	
						}
					}
					?>
				</div>
