...
<?php 
$per_hal=10;
$jumlah_record=mysqli_query("SELECT COUNT(*) from barang");
...
<table class="table table-hover">
	...
	if(isset($_GET['cari'])){
		...
		$brg=mysqli_query("select * from barang where nama like '$cari' or jenis like '$cari'");
	}else{
		$brg=mysqli_query("select * from barang limit $start, $per_hal");
	}
	$no=1;
	...
	<!--<tr>
		...
		<?php 
			...
			$x=mysqli_query("select sum(modal) as total from barang");	
